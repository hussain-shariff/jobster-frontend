    ...
    <div className='text-white text-center md:text-start relative mt-20'>
        ...
        <div className='relative px-8 md:px-0 flex flex-col md:flex-row gap-10 items-center justify-between md:items-start md:gap-0'>
            <div className='max-w-xl'>
                ...
                <div className='flex flex-col justify-center items-center md:flex-row gap-4 mt-7'>
                    <Link to={'/register'}>
                        <button className='bg-gradient-to-r from-[#711beb] to-[#b24af2] py-2 px-10 rounded-md font-semibold hover:scale-95 transition ease-out duration-500'>
                            Register
                        </button>
                    </Link>
                    <Link to={'/signIn'}>
                        <button className='transition ease-out duration-500 border-2 border-[#b135eb] py-2 px-10 rounded-md hover:bg-[#b135eb] font-semibold'>
                            Sign In
                        </button>
                    </Link>
                </div>
